                   ...
                   <div class="col-12">
                       ...
                       <div class="ad_datatable_wrapper">
                        <div class="row align-items-center ad_mBottom20">
                            <div class="col-4">
                                <h5 class="ad_subheading"><?= $pagename ?></h5>
                            </div>
...
<button class="ad_btn bg-blue ad_mLeft10" onclick="window.location.href='<?= base_url('admin/addnew/'.$pagetype) ?>';">Add New</button>
                            </div>
                        </div>
                        <table id="example" class="table ad_table" style="width:100%" data-source="<?= base_url('lists/'.$pagetype.'/list') ?>">
                            <thead>
                                <tr>
                                    <th>Sr.No.</th>
                                    <?= $pagetype == 'bonus' ? '' : '<th>Niche</th>' ; ?>
                                    <th>Title</th>
                                    <th>Edit</th>
                                    <th>Delete</th>
                                </tr>
