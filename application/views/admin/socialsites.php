                   ...
                   <div class="col-12">
                       ...
                       <div class="ad_datatable_wrapper">
                        <div class="row align-items-center ad_mBottom20">
                            <div class="col-4">
                                <h5 class="ad_subheading">Social Sites</h5>
                            </div>
                            <div class="col text-right">
                                ...
                                <!-- <button class="ad_btn bg-blue ad_mLeft10" onclick="updateSocialSites()">Save Everything</button> -->
                            </div>
                        </div>
                        <table id="example" class="table ad_table" style="width:100%" data-source="<?= base_url('admin/socialsites/list') ?>">
                            <thead>
                                <tr>
                                    <th>Sr.No.</th>
                                    <th>Social Sites</th>
                                    ...
                                    for($i=0;$i<count($colName);$i++) { ?>
                                        <th><?= ucwords(str_replace('_',' ',$colName[$i])) ?></th>
                                    <?php } } ?>
                                </tr>
                            </thead>
                            <tbody>
