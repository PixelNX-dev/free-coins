    ...
    <div class="row ad_mTop50">
        <div class="col-12">
            ...
            <div class="row align-items-center ad_mBottom20">
                <div class="col-4">
                    <h5 class="ad_subheading">Categories</h5>
                </div>
                <div class="col text-right">
                    ...
                    <button class="ad_btn bg-blue ad_mLeft10" onclick="window.location.href='<?= base_url('admin/addnew/categories') ?>';">Add New</button>
                </div>
            </div>
            <table id="example" class="table ad_table" style="width:100%" data-source="<?= base_url('admin/categories/list') ?>">
                <thead>
                    <tr>
                        <th>Sr.No.</th>
                        <th>Category</th>
